...
const QUESTION_DATA = [
  ...
  {
    question: <span>What is an example of a practical use case for recursion?</span>,
    answers: [
  ...
  {
    question: <span>What is the difference between <code>=</code>, <code>==</code>, and <code>===</code>?</span>,
    answers: [
  ...
  {
    question: <span>In React, what is the execution order for methods and lifecycle hooks on initial render?</span>,
    answers: [
